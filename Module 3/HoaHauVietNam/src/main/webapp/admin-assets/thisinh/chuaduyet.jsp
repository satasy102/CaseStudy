        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="showthisinh?action=chuaduyet" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <table class="table table-striped table-hover">
              ...
              <c:forEach items="${danhSachThiSinh}" var="danhSachThiSinh">
                <tr>
                  ...
                  <td>
                    <a href="suathisinh?id=${danhSachThiSinh.idThiSinh}" class="settings" title="Sửa" data-toggle="tooltip"><i
                      class="material-icons">&#xE8B8;</i></a>
                    <a href="xoathisinh?id=${danhSachThiSinh.idThiSinh}" class="delete" title="Xóa" data-toggle="tooltip"><i
                      class="material-icons">&#xE5C9;</i></a>
                  </td>
                </tr>
              </c:forEach>
