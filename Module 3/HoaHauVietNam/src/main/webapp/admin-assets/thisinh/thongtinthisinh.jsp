...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Đỗ Chánh Tín</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="showthisinh" class="nav-link active">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="./admin-assets/baiviet.jsp" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Quản lý Bài viết
              </p>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-sm-11">
      <a href="showthisinh" class="btn btn-secondary">Trở lại</a>
    </div>
          ...
          <form method="post" action="suathisinh">
            <fieldset>
              ...
              <table class="table table-striped table-hover">
                ...
                <tr>
                  <td>Ngày sinh:</td>
                  <td><input type="text" name="ngaySinh" value="${thiSinh.ngaySinh}"  class="form-control"required>
                  </td>
                </tr>
                <tr>
                  <td>Địa chỉ:</td>
                  <td><input type="text" name="diaChiCuTru" value="${thiSinh.diaChiCuTru}" class="form-control" required></td>
                </tr>
                <tr>
                  <td>Số điện thoại :</td>
                ...
                <tr>
                  ...
                  <td><input type="text" name="cmt" value="${thiSinh.chungMinhNhanDan}" class="form-control" required></td>
                </tr>
                <tr>
                  <td>Nghề nghiệp:</td>
                  <td><input type="text" name="ngheNghiep" value="${thiSinh.ngheNghiep}" class="form-control" required></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" name="donViCongTac" value="${thiSinh.donViCongTac}" class="form-control" required></td>
                </tr>
                <tr>
                  <td>Chiều cao:</td>
                  <td>
                    <input type="text" name="chieuCao" value="${thiSinh.chieuCao}" class="form-control" required>
                  </td>
                </tr>
                <tr>
                  <td>Cân nặng:</td>
                  <td><input type="text" name="canNang" value="${thiSinh.canNang}" class="form-control" required></td>
                </tr>
                <tr>
                  <td>Năng khiếu khác:</td>
                  <td><input type="text" name="nangKieuKhac" value="${thiSinh.nangKhieuKhac}" class="form-control" required></td>
                </tr>
                <tr>
                  <td>Ảnh cá nhân:</td>
                  <td><input type="text" name="anhCaNhan" value="${thiSinh.anhCaNhan}" class="form-control" required></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" name="trangThai" value="${thiSinh.trangThaiDuyet}" class="form-control" required></td>
                </tr>
                <tr>
