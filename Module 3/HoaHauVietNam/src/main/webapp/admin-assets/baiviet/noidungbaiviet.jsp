          ...
          <div class="table-wrapper">
            <div class="table-title">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <a href="${pageContext.request.contextPath}/thembaiviet" class="btn btn-secondary"><i class="material-icons">&#xE147;</i>
            ...
            <table class="table table-striped table-hover">
              ...
              <c:forEach items="${danhSachBaiViet}" var="danhSachBaiViet">
                <tr>
                  <td>${danhSachBaiViet.tieuDe}</td>
                  <td>${danhSachBaiViet.noiDungTomTat}</td>
                  <td>
                    <a href="suatinhthanh?id=${danhSachTinhThanh.idTinh}" class="settings" title="Sửa" data-toggle="tooltip"><i
                      class="material-icons">&#xE8B8;</i></a>
                    <a href="xoatinhthanh?id=${danhSachTinhThanh.idTinh}" class="delete" title="Xóa" data-toggle="tooltip"><i
                      class="material-icons">&#xE5C9;</i></a>
                  </td>
                </tr>
              </c:forEach>
